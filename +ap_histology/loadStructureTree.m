...
function structureTreeTable = AP_loadStructureTree(fn)
% function structureTreeTable = loadStructureTree(fn)
% note: use an edited version that doesn't have commas in any fields... 
%
% AP didn't write this, it was directly copied from: 
% https://github.com/cortex-lab/allenCCF/blob/master/Browsing%20Functions/loadStructureTree.m
%
% AP prefix was added to remove dependency on that repository
