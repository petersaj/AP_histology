...
channel_properties_table.DisplayDataChangedFcn = {@update_channel_properties,histology_gui,channel_properties_table};

% Set initial options
update_channel_properties([],[],histology_gui,channel_properties_table)
...
function update_channel_properties(obj,event,histology_gui,channel_properties_table)
% Update main GUI on channel property change
...
% Update color of rows in channel properties
channel_properties_table.BackgroundColor = channel_colors;
